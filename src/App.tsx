...
const casinos: Casino[] = [
  { id: "casino777", rank: 1, name: "Casino777.lv", logo: "/logos/casino777.png", domain: "https://casino777.lv", rating: 5.0, bonus: "100% до €200 + 77 фриспинов", payoutSpeed: "До 24 часов", games: 2500, minDeposit: "€5", support: "24/7 Live Chat", license: "IAUI (Latvia)", pros: ["Моментальная верификация","Щедрые акции","Сильная мобильная версия"], cons: ["Не все провайдеры доступны из EU без VPN"], tags: ["Latvia","Top Pick","Fast Payouts"] },
  ...
  { id: "fenikss", rank: 7, name: "FenikssCasino.lv", logo: "/logos/fenikss.png", domain: "https://feniksscasino.lv", rating: 2.8, bonus: "Стартовый пакет", payoutSpeed: "2–4 дня", games: 900, minDeposit: "€10", support: "Рабочие часы", license: "IAUI (Latvia)", pros: ["Известная сеть залов"], cons: ["Слабый онлайн-фокус"], tags: ["Latvia"] },
  ...
  { id: "klondaika", rank: 9, name: "Klondaika.lv", logo: "/logos/klondaika.png", domain: "https://www.klondaika.lv", rating: 2.7, bonus: "До €30", payoutSpeed: "2–4 дня", games: 800, minDeposit: "€10", support: "Рабочие часы", license: "IAUI (Latvia)", pros: ["Простая навигация"], cons: ["Мало игр"], tags: ["Latvia"] },
              ...
              <table className="w-full min-w[600px] text-sm">
                <thead className="bg-white/5 text-white/70">
                  <tr>
                    ...
                    <th className="px-3 py-2 text-left">Лимиты</th>
